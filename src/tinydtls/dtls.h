...
typedef struct __attribute__((__packed__)) {
  ...
  uint16ptr version;		/**< Protocol version */
  uint16ptr epoch;		        /**< counter for cipher state changes */
  uint48ptr sequence_number;       /**< sequence number */
  uint16ptr length;		/**< length of the following fragment */
  /* fragment */
...
typedef struct __attribute__((__packed__)) {
  ...
  uint24ptr length;  /**< length of this message */
  uint16ptr message_seq; 	/**< Message sequence number */
  uint24ptr fragment_offset;	/**< Fragment offset. */
  uint24ptr fragment_length;	/**< Fragment length. */
  /* body */
} dtls_handshake_header_t;

/** Structure of the Client Hello message. */
typedef struct __attribute__((__packed__)) {
  uint16ptr version;	  /**< Client version */
  uint32ptr gmt_random;	  /**< GMT time of the random byte creation */
...
typedef struct __attribute__((__packed__)) {
  uint16ptr version;		/**< Server version */
