...
typedef struct netq_t {
  ...
  uint16_t version;     /**< to be used on retransmissions, the original version number */
  uint16_t epoch;       /**< used also on retransmissions */
  uint64_t rseq;        /**< to be used on retransmissions, the original seqn number */
  uint8_t type;
